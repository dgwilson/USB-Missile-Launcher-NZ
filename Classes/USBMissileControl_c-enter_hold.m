...
//        kr = (*missileInterface)->GetInterfaceSubClass(missileInterface, &interfaceSubClass);
		...
		if (debugCommands)
			NSLog(@"USBMissileControl: FindInterfaces: USBInterfaceOpen (0x%08x) kr=(0x%08x)", missileInterface, kr);
...
#pragma mark - c-enter
		...
		if ([[privateDataRef getLauncherType] isEqualToString:@"c-enter"])
		{
			...
			//  Markus: I commented the following sequence because otherwise the WinBond launcher would not
			//  stop to move everytime
			//			if (controlBits & 16)
			//			{
...
/*
 ...
 69	in up	n/a	1.042	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 71	in up	n/a	1.055	CONTROL_TRANSFER	51 00 7f 7f 00	0x00000000
 73	in up	n/a	1.162	CONTROL_TRANSFER	5d 00 7f 7f 00	0x00000000

 // e1 e0 = ????  >>> Down <<< ???		(e1 = 225 decimal)
 509	in up	n/a	5.889	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 511	in up	n/a	5.920	CONTROL_TRANSFER	5e e1 e0 ff 00	0x00000000
 513	in up	n/a	5.928	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 515	in up	n/a	5.965	CONTROL_TRANSFER	5e e1 e0 ff 00	0x00000000
 
 // e2 e0 = ????  >>> Up <<< ???		(e2 = 226 decimal)
 241	in up	n/a	2.977	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 243	in up	n/a	3.015	CONTROL_TRANSFER	5e e2 e0 ff 00	0x00000000
 245	in up	n/a	3.023	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 247	in up	n/a	3.063	CONTROL_TRANSFER	5e e2 e0 ff 00	0x00000000

 // e0 eo = ????  >>> ???? <<< ???		(e0 = 224 decimal)
 481	in up	n/a	5.571	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 483	in up	n/a	5.604	CONTROL_TRANSFER	5e e0 e0 ff 00	0x00000000
 485	in up	n/a	5.612	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 487	in up	n/a	5.636	CONTROL_TRANSFER	5e e0 e0 ff 00	0x00000000

 // a0 e0 = ????  >>> ???? <<< ???		(a0 = 160 decimal)
 803	in up	n/a	8.991	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 805	in up	n/a	9.022	CONTROL_TRANSFER	5e a0 e0 ff 00	0x00000000
 807	in up	n/a	9.030	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 809	in up	n/a	9.069	CONTROL_TRANSFER	5e a0 e0 ff 00	0x00000000

 // a2 e0 = ????  >>> ???? <<< ???		(a2 = 162 decimal)
 213	in up	n/a	2.637	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 215	in up	n/a	2.695	CONTROL_TRANSFER	5e a2 e0 ff 00	0x00000000
 217	in up	n/a	2.703	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 219	in up	n/a	2.735	CONTROL_TRANSFER	5e a2 e0 ff 00	0x00000000
 
 // a4 e0 = ????  >>> Right <<< ???		(a4 = 165 decimal)
 1235	in up	n/a	13.839	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 1237	in up	n/a	13.870	CONTROL_TRANSFER	5e a4 e0 ff 00	0x00000000
 1239	in up	n/a	13.870	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 1241	in up	n/a	13.901	CONTROL_TRANSFER	5e a4 e0 ff 00	0x00000000

 // a8 e0 = ????  >>> left <<< ???		(a8 = 168 decimal)
 905	in up	n/a	10.185	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 907	in up	n/a	10.223	CONTROL_TRANSFER	5e a8 e0 ff 00	0x00000000
 909	in up	n/a	10.231	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 911	in up	n/a	10.270	CONTROL_TRANSFER	5e a8 e0 ff 00	0x00000000

 // b0 e0 = ????  >>> ???? <<< ???		(b0 = 176 decimal)
 1767	in up	n/a	19.650	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 1769	in up	n/a	19.670	CONTROL_TRANSFER	5e b0 e0 ff 00	0x00000000
 1771	in up	n/a	19.680	CONTROL_TRANSFER	5c 14 7f 7f 00	0x00000000
 1773	in up	n/a	19.700	CONTROL_TRANSFER	5e b0 e0 ff 00	0x00000000

 // b0 e0 = ????  >>> ???? <<< ???		(b0 = 176 decimal)
 1887	in up	n/a	21.125	CONTROL_TRANSFER	5c 16 7f 7f 00	0x00000000
 1889	in up	n/a	21.161	CONTROL_TRANSFER	5e b0 e0 ff 00	0x00000000
 1891	in up	n/a	21.169	CONTROL_TRANSFER	5c 16 7f 7f 00	0x00000000
 1893	in up	n/a	21.206	CONTROL_TRANSFER	5e b0 e0 ff 00	0x00000000
 ...
 // e0 eo = ????  >>> ???? <<< ???		(e0 = 224 decimal)  1110 0000
 // e1 e0 = ????  >>> DOWN <<< ???		(e1 = 225 decimal)  1110 0001
 // e2 e0 = ????  >>> UP   <<< ???		(e2 = 226 decimal)  1110 0010
 // a0 e0 = ????  >>> ???? <<< ???		(a0 = 160 decimal)  1010 0000
 // a1 e0 = ????  >>> ???? <<< ???		(a1 = 161 decimal)  1010 0001 * this may be bogus I'm just filling it in
 // a2 e0 = ????  >>> ???? <<< ???		(a2 = 162 decimal)  1010 0010
 // a4 e0 = ????  >>> Right <<< ???		(a4 = 165 decimal)  1010 0100
 // a8 e0 = ????  >>> Left <<< ???		(a8 = 168 decimal)  1010 1000
 // b0 e0 = ????  >>> ???? <<< ???		(b0 = 176 decimal)  1011 0000
...
//		 - All the way up 
//		 - Fire Has completed 
//		 - Fire Has completed and we're all the way left
//		 - Fire Has completed and we're all the way right
...
//			907	in up	n/a	10.223	CONTROL_TRANSFER	5e a8 e0 ff 00	0x00000000
			...
			if (controlBits & 1)
				reqBuffer[1] = 0xa8;//left
			
			if (controlBits & 2)
				reqBuffer[1] = 0xa4;//right
...
//			NSLog(@"USBMissileControl: controlBits %d", controlBits);
			...
			if (controlBits & 16)
			{
				...
				for (delayCounter = 0; delayCounter < 500; delayCounter ++)
				{
					...
					rbBuffer[0] = 0x00;
//					kr = RocketBabyReadPipe(missileDevice, missileInterface, rbBuffer);
					RocketBabyReadPipe(missileDevice, missileInterface, rbBuffer);
					if (rbBuffer[0] & 0x10)
					{
...
#pragma mark OICStorm
		...
		if ([[privateDataRef getLauncherType] isEqualToString:@"OICStorm"])
		{
			...
			if (rbBuffer[1] & 0x01)  // Bitwise AND -- http://en.wikipedia.org/wiki/Operators_in_C_and_C_Plus_Plus
			{
				if (controlBits & 8)
				{
					if (debugCommands)
				...
				if (rbBuffer[1] & 0x02)  // Bitwise AND -- http://en.wikipedia.org/wiki/Operators_in_C_and_C_Plus_Plus
				{
					if (controlBits & 4)
					{
						if (debugCommands)
			...
			if (rbBuffer[1] & 0x04)  // Bitwise AND -- http://en.wikipedia.org/wiki/Operators_in_C_and_C_Plus_Plus
			{
				if (controlBits & 1)
				{
					if (debugCommands)
			...
			if (rbBuffer[1] & 0x08)  // Bitwise AND -- http://en.wikipedia.org/wiki/Operators_in_C_and_C_Plus_Plus
			{
				if (controlBits & 2)
				{
					if (debugCommands)
...
//				NSLog(@"USBMissileControl: controlBits %d", controlBits);
			...
			if (controlBits & 16)
			{
				...
				for (delayCounter = 0; delayCounter < 500; delayCounter ++)
				{
					...
					rbBuffer[0] = 0x00;
					//					kr = OICStormReadPipe(missileDevice, missileInterface, rbBuffer);
					OICStormReadPipe(missileDevice, missileInterface, rbBuffer);
					if (rbBuffer[1] & 0x10)
					{
						// The 0x10 status doesn't always mean that firing has occurred, but it will be very close
						// - wait at least 500ms before sending 0x20 after receiving 0x10
...
IOReturn OICStormReadPipe(IOUSBDeviceInterface **missileDevice, IOUSBInterfaceInterface **missileInterface, UInt8 *rBuffer)
{
	...
	// the GetPipeStatus when issued to the Rocket Baby crashes the application - DGW 17Nov07
	if (debugCommands)
		NSLog(@"USBMissileControl: OICStormReadPipe: GetPipeStatus");
	
	if (debugCommands)
		NSLog(@"USBMissileControl: OICStormReadPipe: pipeRef = 1");
	...
	// See comments at end for details
	bzero(rBuffer, dreamCheekyMaxPacketSize);
	bytesRead = dreamCheekyMaxPacketSize;  // leave one byte at the end for NULL termination
